...
=======
    ...
    const emptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - (isSuccess ? catalogs.length : 0)) : 0;
    ...
    return (
      <TableContainer component={Paper}>
        ...
        >
          <TableBody>
            {(rowsPerPage > 0
              ? (isSuccess ? catalogs.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) : [])
              : (isSuccess ? catalogs : [])
            ).map((catalog) => (
